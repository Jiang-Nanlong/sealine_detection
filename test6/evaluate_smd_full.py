...
Inputs:
  ...
  - test6/weights/best_fusion_cnn_smd.pth (CNN)
  - test6/weights_smd/smd_rghnet_best_seg_c2.pth (UNet)
  - test6/splits_smd/test_indices.npy

Outputs:
  - test6/eval_smd_full.csv
...
CNN_WEIGHTS_PATH = TEST6_DIR / "weights" / "best_fusion_cnn_smd.pth"
UNET_WEIGHTS_PATH = TEST6_DIR / "weights_smd" / "smd_rghnet_best_seg_c2.pth"
DCE_WEIGHTS_PATH = PROJECT_ROOT / "weights" / "Epoch99.pth"

# Output
OUT_DIR = TEST6_DIR / "eval_smd_full_outputs"
