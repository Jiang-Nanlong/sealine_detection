...
Inputs:
  - test1/FusionCache_Buoy/test/
  - test1/weights/best_fusion_cnn_buoy.pth (CNN)
  - test1/weights_buoy/buoy_rghnet_best_seg_c2.pth (UNet)
  - test1/splits_buoy/test_indices.npy

Outputs:
  - test1/eval_buoy_full_outputs/full_eval_buoy_test.csv
...
CACHE_DIR = test1_DIR / "FusionCache_Buoy" / "test"
SPLIT_DIR = test1_DIR / "splits_buoy"
CNN_WEIGHTS_PATH = test1_DIR / "weights" / "best_fusion_cnn_buoy.pth"
UNET_WEIGHTS_PATH = test1_DIR / "weights_buoy" / "buoy_rghnet_best_seg_c2.pth"
DCE_WEIGHTS_PATH = PROJECT_ROOT / "weights" / "Epoch99.pth"

# Output
OUT_DIR = test1_DIR / "eval_buoy_full_outputs"
