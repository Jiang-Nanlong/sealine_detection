...
def _build_linea_with_entropy_lazy(args):
    from method1_linea_entropy.models.linea_with_entropy import build_linea_with_entropy
    return build_linea_with_entropy(args)

def _build_linea_with_entropy_a_lazy(args):
    from method1_linea_entropy.models.linea_with_entropy import build_linea_with_entropy_a
    return build_linea_with_entropy_a(args)

def _build_linea_with_entropy_b_lazy(args):
    from method1_linea_entropy.models.linea_with_entropy import build_linea_with_entropy_b
    return build_linea_with_entropy_b(args)

def _build_linea_with_entropy_b_enhanced_lazy(args):
    from method1_linea_entropy.models.linea_with_entropy import build_linea_with_entropy_b_enhanced
...
def _build_criterion_ranking_lazy(args):
    from method1_linea_entropy.models.criterion_ranking import build_criterion_ranking
