"""
ablation_mslep_sai_musid.py — 消融实验：MSLEP + SAI

用法：
  python LINEA/main.py -c method1_linea_entropy/configs/ablation_mslep_sai_musid.py

模型：LINEA_ENTROPY_B_ENHANCED（关闭 EGAB / HASH）
...
消融表第 4 行：Baseline → 单尺度熵 → MSLEP → **MSLEP + SAI**
"""
...
# 输出目录
# ============================================================
output_dir = 'output/ablation_mslep_sai_musid_e130'
