...
用法：
  python -m method1_linea_entropy.analyze_model_overhead
"""
...
EXPERIMENTS = [
    {
        "tag": "Baseline",
        "mode": "baseline",
        "config": "method1_linea_entropy/configs/linea_baseline_musid.py",
        "weights": "output/linea_baseline_musid_e100/best_checkpoint.pth",
    },
    {
        "tag": "+MSLEP",
        "mode": "entropy_b_enhanced",
        "config": "method1_linea_entropy/configs/ablation_mslep_only_musid.py",
        "weights": "output/ablation_mslep_only_musid_e130/best_checkpoint.pth",
    },
    {
        "tag": "+MSLEP+SAI",
        "mode": "entropy_b_enhanced",
        "config": "method1_linea_entropy/configs/ablation_mslep_sai_musid.py",
        "weights": "output/ablation_mslep_sai_musid_e130/best_checkpoint.pth",
    },
    {
        "tag": "+MSLEP+SAI+EGAB",
        "mode": "entropy_b_enhanced",
        "config": "method1_linea_entropy/configs/ablation_mslep_sai_egab_musid.py",
        "weights": "output/linea_entropy_b_enhanced_musid_v2_e130/best_checkpoint.pth",
    },
    {
        "tag": "Full(+HASH+Rank)",
        "mode": "entropy_b_enhanced",
        "config": "method1_linea_entropy/configs/linea_entropy_b_enhanced_musid.py",
        "weights": "output/linea_entropy_b_enhanced_musid_v2_e130/best_checkpoint.pth",
    },
]

OUTPUT_DIR = "method1_linea_entropy/overhead_analysis"
